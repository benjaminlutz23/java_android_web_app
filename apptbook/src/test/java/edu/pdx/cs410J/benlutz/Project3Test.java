...
class Project3Test extends InvokeMainTestCase{
  ...
  void printFlagPrintsAppointmentDetails() {
    ...
    InvokeMainTestCase.MainMethodResult result = invokeMain(Project3.class, args);
    assertThat(result.getTextWrittenToStandardOut(), containsString("description"));
  }

  @Test
  void invalidOptionPrintsErrorToStandardError() {
    InvokeMainTestCase.MainMethodResult result = invokeMain(Project3.class, "-invalidOption");
